...
-- SỬA: technician_id 1 -> 9 (Lê Minh Khôi)
(1, 9, DATEADD(HOUR, 9, DATEADD(DAY, -30, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), DATEADD(HOUR, 11, DATEADD(DAY, -30, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), DATEADD(HOUR, 11, DATEADD(DAY, -30, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), N'Hoàn thành bảo dưỡng định kỳ (Job của Booking 1)', DATEADD(HOUR, 8, DATEADD(DAY, -30, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), DATEADD(HOUR, 11, DATEADD(DAY, -30, CAST(CAST(GETDATE() AS DATE) AS DATETIME)))),
-- SỬA: technician_id 2 -> 10 (Phan Thanh Tùng)
(2, 10, DATEADD(HOUR, 9, DATEADD(DAY, -25, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), DATEADD(HOUR, 11, DATEADD(DAY, -25, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), DATEADD(HOUR, 11, DATEADD(DAY, -25, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), N'Đã thay dầu động cơ (Job của Booking 2)', DATEADD(HOUR, 8, DATEADD(DAY, -25, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), DATEADD(HOUR, 11, DATEADD(DAY, -25, CAST(CAST(GETDATE() AS DATE) AS DATETIME)))),
-- SỬA: technician_id 3 -> 11 (Võ Quốc Trung)
(3, 11, DATEADD(HOUR, 9, DATEADD(DAY, -20, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), DATEADD(HOUR, 11, DATEADD(DAY, -20, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), DATEADD(HOUR, 11, DATEADD(DAY, -20, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), N'Kiểm tra và sửa lỗi hệ thống phanh (Job của Booking 3)', DATEADD(HOUR, 8, DATEADD(DAY, -20, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), DATEADD(HOUR, 11, DATEADD(DAY, -20, CAST(CAST(GETDATE() AS DATE) AS DATETIME)))),
-- SỬA: technician_id 1 -> 9
(4, 9, DATEADD(HOUR, 9, DATEADD(DAY, -15, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), DATEADD(HOUR, 11, DATEADD(DAY, -15, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), DATEADD(HOUR, 11, DATEADD(DAY, -15, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), N'Thay pin, SoH 100% (Job của Booking 4)', DATEADD(HOUR, 8, DATEADD(DAY, -15, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), DATEADD(HOUR, 11, DATEADD(DAY, -15, CAST(CAST(GETDATE() AS DATE) AS DATETIME)))),
-- SỬA: technician_id 2 -> 10
(5, 10, DATEADD(HOUR, 9, DATEADD(DAY, -10, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), DATEADD(HOUR, 11, DATEADD(DAY, -10, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), DATEADD(HOUR, 11, DATEADD(DAY, -10, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), N'Kiểm tra tổng quát (Job của Booking 5)', DATEADD(HOUR, 8, DATEADD(DAY, -10, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), DATEADD(HOUR, 11, DATEADD(DAY, -10, CAST(CAST(GETDATE() AS DATE) AS DATETIME)))),
-- SỬA: technician_id 3 -> 11
(6, 11, DATEADD(HOUR, 9, DATEADD(DAY, -7, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), DATEADD(HOUR, 11, DATEADD(DAY, -7, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), DATEADD(HOUR, 11, DATEADD(DAY, -7, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), N'Cập nhật phần mềm S-OTA (Job của Booking 6)', DATEADD(HOUR, 8, DATEADD(DAY, -7, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), DATEADD(HOUR, 11, DATEADD(DAY, -7, CAST(CAST(GETDATE() AS DATE) AS DATETIME)))),
-- SỬA: technician_id 1 -> 9
(7, 9, DATEADD(HOUR, 9, DATEADD(DAY, -5, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), DATEADD(HOUR, 11, DATEADD(DAY, -5, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), DATEADD(HOUR, 11, DATEADD(DAY, -5, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), N'Sửa lỗi kết nối Bluetooth (Job của Booking 7)', DATEADD(HOUR, 8, DATEADD(DAY, -5, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), DATEADD(HOUR, 11, DATEADD(DAY, -5, CAST(CAST(GETDATE() AS DATE) AS DATETIME)))),
-- SỬA: technician_id 2 -> 10
(8, 10, DATEADD(HOUR, 9, DATEADD(DAY, -4, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), DATEADD(HOUR, 11, DATEADD(DAY, -4, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), DATEADD(HOUR, 11, DATEADD(DAY, -4, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), N'Hoàn thành bảo dưỡng (Job của Booking 8)', DATEADD(HOUR, 8, DATEADD(DAY, -4, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), DATEADD(HOUR, 11, DATEADD(DAY, -4, CAST(CAST(GETDATE() AS DATE) AS DATETIME)))),
-- SỬA: technician_id 3 -> 11
(9, 11, DATEADD(HOUR, 9, DATEADD(DAY, -3, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), DATEADD(HOUR, 11, DATEADD(DAY, -3, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), DATEADD(HOUR, 11, DATEADD(DAY, -3, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), N'Hoàn thành bảo dưỡng (Job của Booking 9)', DATEADD(HOUR, 8, DATEADD(DAY, -3, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), DATEADD(HOUR, 11, DATEADD(DAY, -3, CAST(CAST(GETDATE() AS DATE) AS DATETIME)))),
-- SỬA: technician_id 1 -> 9
(10, 9, DATEADD(HOUR, 9, DATEADD(DAY, -2, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), DATEADD(HOUR, 11, DATEADD(DAY, -2, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), DATEADD(HOUR, 11, DATEADD(DAY, -2, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), N'Hoàn thành bảo dưỡng (Job của Booking 10)', DATEADD(HOUR, 8, DATEADD(DAY, -2, CAST(CAST(GETDATE() AS DATE) AS DATETIME))), DATEADD(HOUR, 11, DATEADD(DAY, -2, CAST(CAST(GETDATE() AS DATE) AS DATETIME)))),

-- === 2. Jobs đang thực hiện (Map với Booking 11, 12, 13) ===
-- SỬA: technician_id 4 -> 12 (Trịnh Quang Vinh)
(11, 12, DATEADD(HOUR, 8, CAST(CAST(GETDATE() AS DATE) AS DATETIME)), DATEADD(HOUR, 10, CAST(CAST(GETDATE() AS DATE) AS DATETIME)), NULL, N'Đang thực hiện chẩn đoán hệ thống điện (Job của Booking 11)', DATEADD(HOUR, 8, CAST(CAST(GETDATE() AS DATE) AS DATETIME)), DATEADD(HOUR, 8, CAST(CAST(GETDATE() AS DATE) AS DATETIME))),
-- SỬA: technician_id 4 -> 12
(12, 12, DATEADD(HOUR, 9, CAST(CAST(GETDATE() AS DATE) AS DATETIME)), DATEADD(HOUR, 11, CAST(CAST(GETDATE() AS DATE) AS DATETIME)), NULL, N'Đang kiểm tra tình trạng pin, SoH 97.2% (Job của Booking 12)', DATEADD(HOUR, 9, CAST(CAST(GETDATE() AS DATE) AS DATETIME)), DATEADD(HOUR, 9, CAST(CAST(GETDATE() AS DATE) AS DATETIME))),
-- SỬA: technician_id 5 -> 13 (Đặng Hữu Phước)
(13, 13, DATEADD(HOUR, 10, CAST(CAST(GETDATE() AS DATE) AS DATETIME)), DATEADD(HOUR, 12, CAST(CAST(GETDATE() AS DATE) AS DATETIME)), NULL, N'Bảo dưỡng tổng quát (Job của Booking 13)', DATEADD(HOUR, 10, CAST(CAST(GETDATE() AS DATE) AS DATETIME)), DATEADD(HOUR, 10, CAST(CAST(GETDATE() AS DATE) AS DATETIME)));
