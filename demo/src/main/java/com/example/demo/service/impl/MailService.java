...
public class MailService implements IMailService {
    ...
    public void sendVerificationMail(String toEmail, String verificationCode) {
        ...
        try {
            ...
            log.info("✅ Verification email sent to {} in {}ms", toEmail, duration);
        } catch (Exception e) {
            long duration = System.currentTimeMillis() - startTime;
            log.error("❌ Failed to send verification email to {} after {}ms: {}", toEmail, duration, e.getMessage());
        }
    }
    ...
    public void sendReminderMail(User user, Vehicle vehicle, double threshold) {
        ...
        try {
            ...
            sendMail(toEmail, subject, htmlContent);
            long duration = System.currentTimeMillis() - startTime;
            log.info("✅ Reminder email sent to {} in {}ms", toEmail, duration);
        } catch (Exception e) {
            long duration = System.currentTimeMillis() - startTime;
            log.error("❌ Failed to send reminder email to {} after {}ms: {}", user.getEmailAddress(), duration, e.getMessage());
        }
    }
    ...
    public void sendPasswordResetMail(String toEmail, String resetLink) {
        ...
        try {
            ...
            sendMail(toEmail, subject, htmlContent);
            long duration = System.currentTimeMillis() - startTime;
            log.info("✅ Password reset email sent to {} in {}ms", toEmail, duration);
        } catch (Exception e) {
            long duration = System.currentTimeMillis() - startTime;
            log.error("❌ Failed to send password reset email to {} after {}ms: {}", toEmail, duration, e.getMessage());
        }
    }
    ...
    public void sendGeneratedPassword(String toEmail, String password) {
        ...
        try {
            ...
            sendMail(toEmail, subject, htmlContent);
            long duration = System.currentTimeMillis() - startTime;
            log.info("✅ Generated password email sent to {} in {}ms", toEmail, duration);
        } catch (Exception e) {
            long duration = System.currentTimeMillis() - startTime;
            log.error("❌ Failed to send generated password email to {} after {}ms: {}", toEmail, duration, e.getMessage());
        }
    }
