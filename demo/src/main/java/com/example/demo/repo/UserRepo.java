...
public interface UserRepo extends JpaRepository<User, Long> {
    ...
    long countByRole_DisplayNameNotAndStatus(String displayName, EntityStatus status);

    long countByRole_DisplayNameAndStatus(String kháchHàng, EntityStatus entityStatus);
    /**
