...
@Tag(name = "Job", description = "Endpoints for managing jobs - Technician, Staff")
public class JobController {
    private final IJobService jobService;

    @PutMapping("/{jobId}/start")
    @Operation(summary = "Start job", description = "Allows a technician or staff to start a job by its id.")
    ...
    @Operation(summary = "Complete job", description = "Allows a technician or staff to complete a job by its id, with optional notes.")
    ...
    @GetMapping("/{jobId}")
    @Operation(summary = "Get job detail", description = "Returns job details by job id. Requires authentication.")
    ...
    @Operation(summary = "Get technician tasks", description = "Returns all jobs assigned to a technician.")
    ...
    @DeleteMapping("/{jobId}")
    @Operation(summary = "Delete job", description = "Allows staff to delete a job by its id.")
    ...
    @GetMapping
    @Operation(summary = "Get jobs filtered", description = "Returns jobs filtered by technician, status, or booking id. Requires authentication.")
